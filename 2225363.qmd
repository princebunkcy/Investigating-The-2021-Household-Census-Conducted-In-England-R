...
H <- df[,c(1,3,4)]
cor_matrix <- cor(H)
heatmap_plot <-ggplot(data = reshape2::melt(cor_matrix), aes(Var1, Var2, fill = value)) +
    geom_tile(color = "white") +
    scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0, limit = c(-1, 1), space = "Lab", name="Correlation") +
    theme_minimal() +
    theme(axis.text.x = element_text(angle = 45, vjust = 1, size = 10, hjust = 1))
ggsave("C:/Users/Hp 2022/Documents/plot1.png",heatmap_plot)
...
plot2<-ggplot(df, aes(x = Marital_Status, y = Income, fill = Eth)) +
    geom_violin() +scale_y_continuous(labels = scales::comma)+
    labs(x = "Marital Status",
         y = "Income",
         fill = "Eth")
ggsave("C:/Users/Hp 2022/Documents/plot2.png",plot2)
...
plot3 <-ggplot(df, aes(x = Age, y = Income, color = Eth)) +
    geom_point() + scale_y_continuous(labels = scales::comma)
ggsave("C:/Users/Hp 2022/Documents/plot3.png",plot3)
```
...
plot4 <-ggplot(df, aes(y = interaction(Eth,`Highest Ed`, sep = "_"), x = Age, fill = Eth )) + 
  geom_col() +
  scale_y_discrete (labels = function(x) gsub("_", " - ", x))+labs(y = NULL)
ggsave("C:/Users/Hp 2022/Documents/plot4.png",plot4)
```
